...
type kz865Band struct {
	band
}

func (b *kz865Band) Name() string {
	return "KZ865"
}

func (b *kz865Band) GetDefaults() Defaults {
	return Defaults{
		RX2Frequency:     866700000,
		RX2DataRate:      0,
...
func (b *kz865Band) GetDownlinkTXPower(freq uint32) int {
	return 14
}

func (b *kz865Band) GetDefaultMaxUplinkEIRP() float32 {
	return 16
}

func (b *kz865Band) GetPingSlotFrequency(lorawan.DevAddr, time.Duration) (uint32, error) {
	return 866700000, nil
}

func (b *kz865Band) GetRX1ChannelIndexForUplinkChannelIndex(uplinkChannel int) (int, error) {
	return uplinkChannel, nil
}

func (b *kz865Band) GetRX1FrequencyForUplinkFrequency(uplinkFrequency uint32) (uint32, error) {
	return uplinkFrequency, nil
}

func (b *kz865Band) ImplementsTXParamSetup(protocolVersion string) bool {
	return false
}

func newKZ865Band(repeaterCompatible bool) (Band, error) {
	b := kz865Band{
		band: band{
			...
			uplinkChannels: []Channel{
				...
				{Frequency: 865300000, MinDR: 0, MaxDR: 5, enabled: true},
				{Frequency: 865500000, MinDR: 0, MaxDR: 5, enabled: true},
				{Frequency: 865700000, MinDR: 0, MaxDR: 5, enabled: true},
				{Frequency: 865900000, MinDR: 0, MaxDR: 5, enabled: true},
			},
